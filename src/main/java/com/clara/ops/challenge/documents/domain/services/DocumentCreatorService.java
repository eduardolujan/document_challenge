...
public class DocumentCreatorService {
  ...
  public static Document createDocument(
      DocumentRepository documentRepository, String user, String documentName)
      throws DocumentParamEmpty {
    if (Objects.isNull(documentName) || documentName.isEmpty()) {
      throw new DocumentParamEmpty(
          "Document name cannot be null or empty %s".formatted(documentName));
    }
