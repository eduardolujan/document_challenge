...
public class DocumentsController {
  ...
  public ResponseEntity<ResponseChallenge> uploadDocument(
    ...
    try {
      ...
      return new ResponseEntity<>(
          new ErrorResponse("Error when tried to upload document %s".formatted(ex.getMessage())),
  ...
  public List<Document> searchDocuments(
    ...
    return documentSearcher.search(
        user, documentName, tags == null ? List.of() : tags, page, pageSize);
  }
  ...
  public ResponseEntity<LinkCreatedResponse> downloadDocument(@PathVariable UUID id) {
    String link = "";
    try {
      DocumentLinkGenerator documentLinkGenerator =
          new DocumentLinkGenerator(documentRepository, linkManager);
